...
,
		"classnamespace" : "box",
		"rect" : [ 1831.0, 549.0, 1238.0, 816.0 ],
		"bglocked" : 0,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 110.0, 446.0, 221.0, 60.0 ],
					"text" : "The Ladder Filter emulates a low pass filter. Change its values with the Offset knob and see the effect on the BIG SPECTRAL module."
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 343.0, 77.0, 95.0, 116.0 ],
					"varname" : "bp.Noise",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 726.0, 77.0, 372.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 726.0, 564.0, 435.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 726.0, 327.0, 372.0, 214.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 343.0, 633.0, 148.0, 116.0 ],
					"varname" : "bp.Stereo",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 343.0, 425.0, 295.0, 116.0 ],
					"varname" : "bp.Ladder",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 378.0, 215.0, 314.0, 116.0 ],
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-2::obj-20" : [ "Freq[1]", "Freq", 0 ],
			"obj-2::obj-22" : [ "TimeMode", "TimeMode", 1 ],
			"obj-2::obj-23" : [ "CV2[1]", "CV2", 0 ],
			"obj-2::obj-28" : [ "Res", "Res", 0 ],
			"obj-2::obj-4" : [ "Offset[1]", "Offset", 0 ],
			"obj-2::obj-54" : [ "CV1", "CV1", 0 ],
			"obj-2::obj-55" : [ "power", "power", 0 ],
			"obj-2::obj-63" : [ "CV3[1]", "CV3", 0 ],
			...
			"obj-6::obj-12" : [ "freq_scale", "LinLog", 0 ],
			"obj-6::obj-26" : [ "amp_scale", "LinLog", 0 ],
			"obj-6::obj-30" : [ "freq_domain_low", "freq_domain_low", 0 ],
			"obj-6::obj-31" : [ "domain_low_midi", "domain_low_midi", 0 ],
			"obj-6::obj-36" : [ "domain_high_midi", "domain_high_midi", 0 ],
			"obj-6::obj-37" : [ "freq_domain_high", "freq_domain_high", 0 ],
			"obj-6::obj-42::obj-2" : [ "pastebang", "pastebang", 0 ],
			"obj-6::obj-7" : [ "display_mode", "display", 0 ],
			"obj-6::obj-9" : [ "PollingInterval", "PollingInterval", 0 ],
			"obj-7::obj-1" : [ "divide[1]", "divide", 0 ],
			"obj-7::obj-129" : [ "Points[1]", "Points", 0 ],
			"obj-7::obj-52" : [ "multiply[1]", "multiply", 0 ],
			"obj-7::obj-69" : [ "Lock[1]", "Lock", 0 ],
			"obj-8::obj-55" : [ "Mute[2]", "Mute", 0 ],
